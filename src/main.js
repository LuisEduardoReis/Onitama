...
var searchTimeSlider, aiRedCheckbox, aiRedCheckbox, showHintsCheckbox, debug, cardSelects, rendered;
...
function setup() {
	...
	searchTimeSlider = createSlider(0, 100, 22.5, 0.5).parent("container");
	...
	cardSelects = [];
	for(var i = 0; i < 5; i++) cardSelects.push(createCardSelect().position(100,645 + i*25).selected(i));
}
...
function draw() {
	...
	stroke(0); strokeWeight(1); text("AI Search Time",0,435);
